...
/**
 * Servlet implementation class GetTeachersInfoServlet
 */
@WebServlet("/servlet/GetTeachersInfoServlet")
public class GetTeachersInfoServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		List<Map<String, Object>> result = tis.getTeacherInfo(page * pagesize, pagesize);
