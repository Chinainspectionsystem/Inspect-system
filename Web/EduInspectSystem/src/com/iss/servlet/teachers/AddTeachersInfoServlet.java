...
/**
 * Servlet implementation class AddTeachersInfoServlet
 */
@WebServlet("/servlet/AddTeachersInfoServlet")
public class AddTeachersInfoServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		int result = tis.addTeachersInfo(tiBean);
