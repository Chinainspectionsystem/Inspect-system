...
/**
 * Servlet implementation class GetCourseInfoServlet
 */
@WebServlet("/servlet/GetCourseInfoServlet")
public class GetCourseInfoServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		ICourseInfoService cis = new CourseInfoServiceImpl();
		List<Map<String, Object>> result = cis.getCourseInfo(page * pagesize, pagesize);
