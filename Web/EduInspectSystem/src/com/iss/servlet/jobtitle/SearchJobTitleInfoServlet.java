...
/**
 * Servlet implementation class SearchJobTitleInfoServlet
 */
@WebServlet("/servlet/SearchJobTitleInfoServlet")
public class SearchJobTitleInfoServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		List<Map<String, Object>> result = jtis.searchJobTitleInfo(jtiBean, page * pagesize, pagesize);
